...
<img src="https://github.com/taniokah/AITOK/blob/main/images/MedicalRisk(de).png?raw=true" width="480pt" alt="ROC Curve"><br>Fig 1. ROC Curves on MedicalRisk(de) of German Task.
